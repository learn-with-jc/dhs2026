# prism/platform/data_models.py
"""
PRism | Core Data Models
...
class PurchaseRequisition(BaseModel):
    ...
    NOTE: PR = Purchase Requisition throughout PRism.
...
class DecisionRecord(BaseModel):
    """
    The final, fully explainable output of the PRism pipeline.
