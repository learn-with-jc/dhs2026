# prism/platform/vector_store.py
"""
PRism | Vector Store + BM25 Retrieval
...
from prism.platform.data_models import RetrievedChunk
...
class VectorStoreManager:
    ...
    POLICY_COLLECTION    = "prism_policies"
    PRECEDENT_COLLECTION = "prism_precedents"
    ...
    @staticmethod
    def _embeddings():
        from prism.platform.llm_provider import get_embeddings
