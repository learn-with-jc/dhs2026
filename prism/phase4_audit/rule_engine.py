# prism/phase4_audit/rule_engine.py
"""
PRism | Phase 4 — Master Rule Engine
...
from prism.phase3_agentic.state import PrismState
from prism.phase4_audit.taxonomy          import resolve_taxonomy
from prism.phase4_audit.recipient_classifier import classify_recipient
from prism.phase4_audit.threshold_engine  import (
    check_meal_per_head, check_total_approval, check_gift_threshold,
)
from prism.phase4_audit.registration_checker import (
    check_gsmm_registration, check_approval_level, check_public_sector_legal,
)
from prism.phase4_audit.exception_catalog import get_applicable_exceptions
...
class AuditRuleEngine:
    ...
    def evaluate(
        ...
        phase3_state:   PrismState | None = None,
    ) -> DecisionRecord:
        """
    ...
    def _build_compliant_record(
        ...
        from prism.platform.data_models import RecipientType, SectorLevel
        return DecisionRecord(
            pr_id            = pr.pr_id,
