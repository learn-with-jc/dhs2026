# prism/phase4_audit/explainability.py
"""
PRism | Phase 4 — Explainability Emitter
...
from prism.platform.data_models import DecisionRecord, VerdictStatus
