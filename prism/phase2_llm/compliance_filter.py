# prism/phase2_llm/compliance_filter.py
"""
PRism | Phase 2 — Compliance Filter (The Inversion Pattern)
...
from prism.phase2_llm.guardrails import GuardrailStack
from prism.phase2_llm.intent_extractor import (
