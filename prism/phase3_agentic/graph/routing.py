# prism/phase3_agentic/graph/routing.py
"""
PRism | Phase 3 — Conditional Edge Routing
...
def route_after_verdict_gate(state: PrismState) -> str:
    """
...
def route_after_critique(state: PrismState) -> str:
    """
