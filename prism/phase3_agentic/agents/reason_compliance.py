# prism/phase3_agentic/agents/reason_compliance.py
"""
PRism | Agent 4 — Reason Compliance
...
from prism.platform.data_models import TraceEvent, PurchaseRequisition
from prism.platform.llm_provider import get_llm
...
def reason_compliance_node(state: PrismState) -> dict:
