# prism/phase3_agentic/agents/retrieve_and_rerank.py
"""
PRism | Agent 3 — Retrieve
...
from prism.platform.vector_store import (
...
def retrieve_and_rerank_node(state: PrismState) -> dict:
