# prism/phase3_agentic/agents/generate_recommendation.py
"""
PRism | Agent 8 — Generate Recommendation
...
from prism.platform.data_models import TraceEvent
...
def generate_recommendation_node(state: PrismState) -> dict:
