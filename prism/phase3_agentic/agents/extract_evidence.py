# prism/phase3_agentic/agents/extract_evidence.py
"""
PRism | Agent 7 — Extract Evidence
...
from prism.platform.data_models import TraceEvent, RetrievedChunk
...
def extract_evidence_node(state: PrismState) -> dict:
