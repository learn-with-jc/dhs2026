# prism/phase3_agentic/state.py
"""
PRism | Phase 3 — LangGraph State Schema
...
def initial_state(pr_data: dict[str, Any]) -> PrismState:
    """
    Create a fresh PrismState for a new PR evaluation.
