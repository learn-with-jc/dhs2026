# prism/phase3_agentic/run_phase3.py
"""
PRism | Phase 3 — Standalone Runner
...
from prism.platform.data_models import PurchaseRequisition, RiskLabel
...
def main() -> None:
    ...
    logger.info("═" * 60)
    logger.info("PRISM | PHASE 3 | Agentic Reasoning")
    logger.info("═" * 60)
    ...
    for pr in review_prs[:5]:   # limit for demo speed
        ...
        if cached:
            ...
            final     = normalize_phase3_result(raw_state)
            cache.set(pr.pr_id, 3, pr_data, final)
